    ...
    <footer class="footer">
        <div class="footer__container _container">
            ...
            <div class="footer__column_second">
                <span class="footer__label">ПОДДЕРЖКА</span>
                <div class="footer__menu">
                    <a href="##"><span>Помощь & Поддержа</span></a>
    ...
    <footer class="_footer">
        <div class="_footer__container _container">
            <div class="footer__copy">@ 2023 - Designed & Develop by Ilshat Nagumanov</div>
        </div>
    </footer>
